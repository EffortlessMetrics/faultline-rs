...
- [x] 1. Phase A: Shared Loader — Scaffold `faultline-loader` crate and add locator types
  - [x] 1.1 Add `ArtifactSource` and `LocatedReport` types to `faultline-types`
  ...
  - [x] 1.2 Scaffold `faultline-loader` crate
  ...
  - [x] 1.3 Implement `locate_and_load_report()` in `faultline-loader`
  ...
  - [x] 1.4 Replace CLI `load_report_from_dir()` with `faultline-loader`
  ...
  - [x] 1.5 Replace xtask `load_report()` with `faultline-loader`
  ...
  - [x] 1.6 Update `diff-runs` to use `faultline-loader` for file-based loading
  ...
  - [x] 1.7 Write property test for report locator precedence (Property 1)
  ...
  - [x] 1.8 Write end-to-end loading tests for all paths (Req 17)
...
- [x] 3. Phase B: Redaction Spine — Core types and pure redaction function
  - [x] 3.1 Add `RedactionPolicy` to `faultline-types`
  ...
  - [x] 3.2 Add `SecretScrubber` with `LazyLock` to `faultline-types`
  ...
  - [x] 3.3 Add `ArtifactProvenance` struct to `faultline-types`
  ...
  - [x] 3.4 Implement `redact_report()` pure function in `faultline-types`
  ...
  - [x] 3.5 Add `is_valid_shell_identifier()` and `to_shell_script_with_policy()` to `faultline-types`
  ...
  - [x] 3.6 Add secret pattern fixture corpus to `faultline-fixtures`
  ...
  - [x] 3.7 Write property tests for redaction completeness (Properties 2–6)
  ...
  - [x] 3.8 Write property tests for store fidelity and unsafe flag (Properties 7–8)
  ...
  - [x] 3.9 Write property tests for provenance, round-trip, schema, idempotence, backward compat, secret scrubbing (Properties 9–14)
...
- [x] 4. Phase B continued: Plumb `RedactionPolicy` through ALL render and export call sites
  - [x] 4.1 Update `ReportRenderer` in `faultline-render` with policy-aware methods
  ...
  - [x] 4.2 Update `to_sarif()` in `faultline-sarif` to accept `RedactionPolicy`
  ...
  - [x] 4.3 Update `to_junit_xml()` in `faultline-junit` to accept `RedactionPolicy`
  ...
  - [x] 4.4 Add `--unsafe-include-env` and `--unsafe-include-output` CLI flags
  ...
  - [x] 4.5 Plumb `RedactionPolicy` through CLI localize flow
  ...
  - [x] 4.6 Plumb `RedactionPolicy` through CLI `run_reproduce()`
  ...
  - [x] 4.7 Plumb `RedactionPolicy` through CLI `run_export_markdown()`
  ...
  - [x] 4.8 Plumb `RedactionPolicy` through xtask export handlers
  ...
  - [x] 4.9 Bump `schema_version` to `"0.3.0"` and regenerate JSON schema
  ...
  - [x] 4.10 Update golden snapshots
...
- [x] 5. Checkpoint — Phase B complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Phase C: Inspect + Bundle commands
  - [x] 6.1 Add `inspect-run` subcommand to `faultline-cli`
  ...
  - [x] 6.2 Implement `inspect-run --json` structured output
  ...
  - [x] 6.3 Add `bundle` subcommand to `faultline-cli`
  ...
  - [x] 6.4 Implement `bundle` command logic
  ...
  - [x] 6.5 Write tests for `inspect-run` and `bundle`
...
- [x] 7. Checkpoint — Phase C complete
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Phase D: Documentation reality sweep
  ...
  - [x] 8.4 Update `docs/verification-matrix.md` and `docs/patterns/catalog.md`
  ...
  - [x] 8.5 Verify `.github/workflows/` match documented tiers
