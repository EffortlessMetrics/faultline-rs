...
| `truncate_output_respects_utf8_char_boundary` | Truncation at byte index inside a multi-byte UTF-8 codepoint backs off to char boundary instead of panicking | 62 ASCII bytes + 4-byte 🦀, limit 64 | faultline-probe-exec | — | UTF-8 safety | — | adapter | — | — | faultline-probe-exec | P0 | faultline-probe-exec | no |
| `truncate_output_at_multi_byte_boundary` | Truncation exactly at the end of a multi-byte codepoint keeps the full character | 62 ASCII bytes + 🦀 + "tail", limit 66 | faultline-probe-exec | — | UTF-8 safety | — | adapter | — | — | faultline-probe-exec | P1 | faultline-probe-exec | no |
